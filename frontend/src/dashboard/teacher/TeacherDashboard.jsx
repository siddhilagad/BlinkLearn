...
function TeacherDashboard() {
  ...
  useEffect(() => {
    ...
    if (userRole !== "teacher") { navigate("/student-dashboard"); return; }
    setUser(storedUser);
      ...
      <div className="teacher-dashboard-wrapper">
        ...
        <div className="teacher-dashboard-hero">
          <div>
            ...
            <p className="dashboard-subtitle">Manage your profile, courses, and students from one place.</p>
          </div>
          <button className="dashboard-main-btn" onClick={() => navigate("/add-course")}>Add Courses</button>
        </div>
        ...
        <div className="teacher-profile-card">
          <div className="teacher-avatar-wrapper">
            ...
            <button className="avatar-upload-btn" onClick={() => fileInputRef.current.click()}
              title="Upload profile photo" disabled={uploadingPhoto}>
              {uploadingPhoto ? "..." : "+"}
            </button>
        ...
        <div className="teacher-section-card">
          ...
          <div className="teacher-overview-grid">
            <div className="teacher-overview-item"><span>Full Name</span><strong>{user?.name || "Teacher Name"}</strong></div>
            <div className="teacher-overview-item"><span>Email</span><strong>{user?.email || "teacher@gmail.com"}</strong></div>
            <div className="teacher-overview-item"><span>Role</span><strong>Teacher</strong></div>
            <div className="teacher-overview-item"><span>Specialization</span><strong>{user?.specialization || "Not Added"}</strong></div>
            <div className="teacher-overview-item"><span>Total Courses</span><strong>{totalCourses}</strong></div>
            <div className="teacher-overview-item"><span>Total Students</span><strong>{totalStudents}</strong></div>
          </div>
        </div>
